...
HD_PWD='C:/Users/andre/OneDrive/Documents/GitHub/Zynq_Tutorial/Zynq_Tutorial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_Example_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_Example_wrapper.tcl
