...
HD_PWD='C:/Users/andre/OneDrive/Documents/GitHub/Zynq_Tutorial/Zynq_Tutorial.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_Example_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Zynq_Example_wrapper.tcl -notrace
