...
HD_PWD='C:/Users/andre/OneDrive/Documents/GitHub/Zynq_Tutorial/Zynq_Tutorial.runs/Zynq_Example_axi_bram_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_Example_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_Example_axi_bram_ctrl_0_0.tcl
